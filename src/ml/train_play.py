...
def objective(trial: optuna.trial.Trial) -> float:
   ...
   # n_layers = trial.suggest_int("n_layers", 1, 3)
    ...
    args = {   
        ...
        "embedding_dim": trial.suggest_uniform("embedding_dim", 20, 200), # Will be made a multiple of n_heads
    ...
    args["embedding_dim"] = int((args["embedding_dim"] // args["n_heads"]) * args["n_heads"])
    model = PlayModel(**args)
    datamodule = PlayModule(db_name="cache/ml_db_0.0.1.h5", batch_size=6400, num_workers=4)
