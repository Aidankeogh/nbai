        ...
        if db_key in db:
            ...
            for season in db:
                ...
                for raw_game in season_games:
                    ...
                    game_possessions = season_possessions[game.possession_start_idx: game.possession_end_idx]
                    for raw_possession in game_possessions:
                        ...
                        game_item = game_item_home if (possession.offense_team == game.home_team) else game_item_away
